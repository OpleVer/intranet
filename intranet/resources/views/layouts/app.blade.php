...
<head>
  ...
  <link href="{!!('assetss/css/weather-icons.min.css')!!}" rel="stylesheet" />
  <script src="{!!('assetss/js/skins.min.js')!!}"></script>
...
<script src="{{asset('assetss/js/slimscroll/jquery.slimscroll.min.js')}}"></script>

<!--Beyond Scripts-->
<script src="{{asset('assetss/js/beyond.min.js')}}"></script>

<!--Page Related Scripts-->

<script src=" {{asset('assetss/js/jquery-ui-1.10.4.custom.js') }}"></script>
<script src="{{asset('assetss/js/fullcalendar/fullcalendar.js') }}"></script>
